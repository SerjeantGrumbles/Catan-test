    ...
    public partial class GameScreen : Form
    {
        ...
        private void GameScreen_Paint(object Sender, PaintEventArgs e)
        {
            ...
            for (int i = 0; i <= hexImages.GetUpperBound(0); i++)
            {
                ...
                {
                    string mainDirectory = @"C:\Users\carthur22\Documents\Visual Studio 2015\Projects\"; //this will change if the project is moved
                    string subDirectory = @"IntegrationTest1.1\IntegrationTest1.1\Resources\"; // this will remain constant

                    try
                    {
                        hexImages[i][j] = (Bitmap)Image.FromFile((mainDirectory + subDirectory + gameBoard.GetHex(i, j)),
                            true);
                        ...
                        formGraphics.DrawPolygon(pen15, points); //draw the outline of the hex
                        formGraphics.FillPolygon(texture, points); //fill the hex with the terrain texture
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            newGame.player1 = new Player(player1.Name, player1.Colour);
            newGame.player2 = new Player(player2.Name, player2.Colour);
            newGame.player3 = new Player(player3.Name, player3.Colour);
            newGame.player4 = new Player(player4.Name, player4.Colour);
            newGame.Show();
            this.Close();*/
        }
